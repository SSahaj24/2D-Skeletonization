#include </home/pratik/miniconda3/envs/dm++/include/opencv2/highgui.hpp>
...
int main(int argc, char* argv[])
{
	...
	//cout << "Persistence threshold: " << persistence_threshold << endl;
	...
	for (int j = 0; j < cols; j++)
	{
		for (int i = 0; i < rows; i++)
		{
			...
			//cout << "vert: " << vert[1] << " " << vert[2] << " " << vert[3]  << endl;
